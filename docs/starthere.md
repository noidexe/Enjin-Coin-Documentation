...
# How do I get started?
  ...
  Still here? Great! We'd love to have you! The first thing you will need to do is signup to the platform and make an ENJ developer account.

  1. Sign up and subscribe [HERE](https://portal.tp-enj.in/). This will give you access to our trusted cloud platform (and Platform API).
  ...
  If you are doing a high number of transactions, or need to automate transaction signing for game severs interacting with players, you should use our wallet daemon. Check out our [wallet daemon guide] for how to get started with that.
  ...
  3. Finally, you need to decide how you are going to interact with the ENJ platform. You'll probably use all of these platform interfaces at one time or another.
    * First, read the game overview to see how game are typically set up to use ENJ [here.]()
